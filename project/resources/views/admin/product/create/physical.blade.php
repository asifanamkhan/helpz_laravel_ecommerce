				...
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
																...
																<div class="product-size-details" id="size-section">
																		...
																		<div  class="row">
																				<div class="col-md-4 col-sm-6">
																					...
																					<input type="text" name="size[]" class="input-field" placeholder="{{ __('Unit Name') }}">
																				</div>
																				<div class="col-md-4 col-sm-6">
																						<label>
																							{{ __('Qty') }} :
																					...
																					<input type="number" name="size_qty[]" class="input-field" placeholder="{{ __('Qty') }}" value="1" min="1">
																				</div>
																				<div class="col-md-4 col-sm-6">
																						<label>
																							{{ __('Price') }} :
																					...
																					<input type="number" name="size_price[]" class="input-field" placeholder="{{ __('Price') }}" value="0" min="0">
																				</div>
																			</div>
																		</div>
																</div>

																<a href="javascript:;" id="size-btn" class="add-more"><i class="fas fa-plus"></i>{{ __('Add More Unit') }} </a>
															</div>
													</div>
													</div>
												<div class="row">
						                    ...
						                    <div class="showbox">
												...
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('Reward point') }}</h4>
																<p class="sub-heading">{{ __('(Optional)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="reward_point" step="0.1" type="number" class="input-field" placeholder="{{ __('e.g 20') }}" min="0">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input name="vendor_name"  type="text" class="input-field" placeholder="{{ __('Enter Vendor Name') }}">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('MF Date') }}</h4>
																<p class="sub-heading">{{ __('(Optional)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="mf_date"  type="date" class="input-field">
													</div>
												</div>
												<div class="row">
													<div class="col-lg-4">
														<div class="left-area">
																<h4 class="heading">{{ __('EXP Date') }}</h4>
																<p class="sub-heading">{{ __('(Optional)') }}</p>
														</div>
													</div>
													<div class="col-lg-7">
														<input name="exp_date" type="date" class="input-field">
													</div>
												</div>
