                                    ...
                                    <tbody>
                                        ...
                                        {{--<tr>--}}
                                            ...
                                            {{--<td>--}}
                                               ...
                                               {{--@if($product['color'])--}}
                                                {{--<p>--}}
                                                        {{--<strong>color :</strong> <span style="width: 20px; height: 5px; display: block; border: 10px solid {{$product['color'] == "" ? "white" : $product['color']}};"></span>--}}
                                                {{--</p>--}}
                                                {{--@endif--}}
                                                {{--<p>--}}
                                                        {{--<strong>Price :</strong> {{$order->currency_sign}}{{ round($product['item']['price'] * $order->currency_value , 2) }}--}}
                                                {{--</p>--}}
                                               {{--<p>--}}
                                                    {{--<strong>Qty :</strong> {{$product['qty']}} {{ $product['item']['measure'] }}--}}
                                               {{--</p>--}}
                                            {{--</td>--}}
